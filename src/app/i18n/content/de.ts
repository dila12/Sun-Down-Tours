...
export const de: Dict = {
  common: {
    ...
    booking: {
      ...
      payAtDestination: 'Später zahlen (Zahlung vor Ort)',
      agreeTerms: 'Ich akzeptiere die AGB',
      acceptTermsError: 'Sie müssen die AGB akzeptieren',
      complete: 'Buchung abschließen',
      bookAheadLead: 'Termine füllen sich schnell',
      bookAheadDetail: 'Private Touren sind begrenzt — sichern Sie sich jetzt Ihren Wunschtermin.',
      demandWarningLead: 'Hohe Nachfrage',
      demandWarningDetail: 'Dieser Tag ist schnell ausgebucht — sichern Sie sich bald Ihren Wunschtermin. Noch online buchbar.',
      oneBookingLeftLead: 'Nur noch 1 Buchung frei',
      oneBookingLeftDetail: 'Dieses Datum ist fast weg — jetzt buchen und Ihren Platz sichern.',
      ...
      bookingsLeftDetail1: 'Dieses Datum ist fast weg — jetzt buchen und Ihren Platz sichern.',
      bookingsLeftDetail2: 'Nur noch wenige Buchungen für dieses Datum — bald reservieren.',
      bookingsLeftDetail3: 'Nur noch wenige Buchungen für dieses Datum — bald reservieren.',
      fewSpotsLeft: 'Wenige Plätze frei',
      almostFullLead: 'Fast ausgebucht',
      almostFullDetail: 'Dieses Datum füllt sich schnell — jetzt buchen und sichern. Noch online buchbar.',
      demandBookSoon: 'Noch online buchbar — sichern Sie sich dieses Datum jetzt.',
      softUrgencyLead: 'Beliebte Termine sind schnell weg',
      softUrgencyDetail: 'Private Touren sind an stark nachgefragten Wochentagen früh ausgebucht.',
      popularDates: 'Beliebte Termine',
      blockedTitle: 'Ausgebucht',
      blockedText:
        'Dieses Abreisedatum ist ausgebucht. Kontaktieren Sie uns für eine Warteliste oder einen anderen Starttermin.',
      peakTitle: 'Hohe Nachfrage',
      peakText:
        'Samstage sind für private Mehrtagesreisen oft ausgebucht. Schreiben Sie uns für aktuelle Verfügbarkeit.',
      confirmLead: 'Vorbehaltlich Bestätigung',
      confirmDetail: 'Wir bestätigen Ihren privaten Fahrer innerhalb von 24 Stunden nach der Buchung.',
      tryAnotherDate: 'Oder wählen Sie oben ein anderes Datum für die Online-Buchung.',
