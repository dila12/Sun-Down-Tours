...
/** Italian (Italiano) - professionally localized copy. */
export const it: Dict = {
  common: {
    ...
    footer: {
      tagline:
        'Il tuo partner di viaggio di fiducia in Sri Lanka: tour guidati, viaggi itineranti ed esperienze su misura con un servizio affidabile.',
      followUs: 'Seguici',
    ...
    tourUi: {
      duration: 'Durata',
      maxPeople: 'Persone max',
      price: 'Prezzo',
      priceBasis: '(basato su 2 persone)',
      ...
      exploreGuides: 'Guide di viaggio utili',
      exploreRestaurants: 'Dove mangiare',
      exploreSimilarTours: 'Tour simili',
      imageAlt: 'Foto del tour in Sri Lanka',
      previewAlt: 'Anteprima della foto del tour',
    },
    card: {
      perPerson: '/ persona',
    ...
    booking: {
      ...
      total: 'Totale',
      payAtDestination: 'Pagamento a destinazione',
  ...
  home: {
    ...
    destinations: {
      ...
      explore: 'Scopri i tour',
      exploreAria: 'Scopri i tour per',
      sigiriya: 'Sigiriya',
      sigiriyaAlt: 'Fortezza di Sigiriya in Sri Lanka',
      ella: 'Ella',
      ellaAlt: 'Treno panoramico di Ella in Sri Lanka',
      yala: 'Safari a Yala',
      ...
      galle: 'Galle',
      galleAlt: 'Forte di Galle in Sri Lanka',
    },
    packages: {
      tag: 'TOUR',
    ...
    services: {
      ...
      s3Desc: 'Hotel selezionati, dai resort di lusso alle guesthouse economiche.',
    },
    faqTitle: 'Domande frequenti',
    faq: [
      {
        q: 'Come prenoto un tour privato in Sri Lanka?',
  ...
  about: {
    ...
    faq: [
      {
        q: 'Da quanto tempo Sundown Tours opera in Sri Lanka?',
        a: 'Creiamo tour privati in Sri Lanka dal 1992, con oltre 30 anni di esperienza locale e migliaia di viaggiatori europei soddisfatti.',
      },
      {
  ...
  services: {
    ...
    title: 'Servizi di viaggio e autista in Sri Lanka',
    ...
    items: {
      ...
      s3Desc: 'Itinerari completamente personalizzati in base alle tue date, ai tuoi interessi, al ritmo e al budget.',
      s4Title: 'Safari',
      s4Desc: 'Safari in jeep a Yala, Udawalawe e Wilpattu per vedere leopardi, elefanti e uccelli esotici.',
      s5Title: 'Prenotazione hotel e alloggi',
      s5Desc: 'Soggiorni selezionati, dai resort di lusso alle guesthouse di charme, alle migliori tariffe.',
      s6Title: 'Trasferimenti aeroportuali ed escursioni',
      s6Desc: "Trasferimenti aeroportuali affidabili ed escursioni private flessibili verso le attrazioni principali.",
    },
    faqTitle: 'Domande frequenti',
    faq: [
      {
  ...
  contact: {
    ...
    trust: {
      ...
      response: 'Risposta rapida entro 24 ore',
      travelers: 'Viaggiatori soddisfatti dal 1992',
    },
    faqTitle: 'Domande frequenti',
    faq: [
      {
  ...
  tour7: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Sette giorni sono una perfetta introduzione allo Sri Lanka e combinano comodamente cultura, paesaggi di montagna e un safari senza fretta.',
      },
      {
  ...
  cancellation: {
    eyebrow: 'Prenotazioni e modifiche',
    h1: 'Politica di cancellazione',
    heroText:
      'Questa pagina spiega come Sundown Tours Sri Lanka gestisce le modifiche di prenotazione, gli acconti e le cancellazioni per tour privati e servizi di autista.',
  ...
  testimonials: {
    ...
    ariaCarousel: 'Testimonianze dei clienti',
    ariaSlide: 'Testimonianza',
  },

  destinationsHub: {
    h1: 'Destinazioni in Sri Lanka',
    breadcrumb: 'Destinazioni',
    lead: 'Dalla fortezza di Sigiriya al territorio dei leopardi di Yala e al forte coloniale di Galle scoprite i luoghi che danno forma a ogni grande itinerario in Sri Lanka.',
    relatedTitle: 'Destinazioni correlate',
  },
  guidesHub: {
    h1: 'Guide di viaggio Sri Lanka',
    breadcrumb: 'Guide di viaggio',
    lead: 'Guide pratiche scritte in loco: visti, stagioni, fauna, spiagge e viaggi con autista privato in Sri Lanka.',
    relatedTitle: 'Guide correlate',
    cardCta: 'Leggi la guida',
    restaurantsTitle: 'Dove mangiare',
    restaurantLink: 'Sundown Beach Restaurant',
    foodGuideLink: 'Guida gastronomica dello Sri Lanka',
  },

  restaurantsExplore: {
    title: 'Destinazioni e tour nelle vicinanze',
    lead: 'Sundown Beach Restaurant è il nostro partner gastronomico a Waskaduwa abbina il pranzo a destinazioni della costa sud-ovest e tour giornalieri.',
  ...
  bookingSuccess: {
    ...
    tourType: 'Tipo di tour',
    payment: 'Pagamento',
    payAtDestination: 'Pagamento in loco',
    ...
    defaultTravelerName: 'Viaggiatore',
    emptyValue: '—',
  },
  ...
  seo: {
    ...
    about: {
      title: 'Chi siamo | Agenzia di viaggi di fiducia in Sri Lanka',
      description:
        'Scopri Sundown Tours Sri Lanka, il tuo tour operator locale di fiducia per tour privati in Sri Lanka dal 1992.',
    ...
    tour8: {
      title: 'Tour Sri Lanka 8 giorni | Safari Wilpattu, Sigiriya, Kandy, Ella e mare',
      description:
        'Vivi lo Sri Lanka in 8 giorni in privato: safari a Wilpattu, Anuradhapura, Sigiriya, Kandy, Ella e soggiorno mare a Hikkaduwa.',
      keywords: 'tour Sri Lanka 8 giorni, Sri Lanka 8 giorni, safari Wilpattu, viaggio privato Sri Lanka',
    },
    tour6: {
    ...
    ellaDay: {
      title: 'Escursione di un giorno a Ella | Treno panoramico e Nine Arch Bridge',
      description:
        'Escursione privata a Ella con Nine Arch Bridge, Little Adam’s Peak e le cascate di Ravana tra le montagne dello Sri Lanka.',
      keywords: 'escursione Ella, gita a Ella, Nine Arch Bridge',
    },
    galleDay: {
      title: 'Escursione di un giorno a Galle | Forte di Galle e costa sud',
      description:
        'Scopri il Forte di Galle, le spiagge e le attrazioni della costa sud con la nostra escursione privata di un giorno.',
      keywords: 'escursione Galle, Forte di Galle, costa sud Sri Lanka',
    },
    kandyDay: {
      title: 'Escursione di un giorno a Kandy | Cultura e paesaggi',
      description:
        'Vivi gli highlights di Kandy, tra cui il Tempio del Dente e il Giardino Botanico Reale, in un’escursione privata di un giorno.',
      keywords: 'escursione Kandy, gita a Kandy, Tempio del Dente',
    },
    sigiriyaDay: {
      title: 'Escursione di un giorno a Sigiriya | Antica fortezza rocciosa',
      description:
        'Esplora l’antica fortezza rocciosa di Sigiriya e i suoi giardini in un’escursione privata di un giorno.',
      keywords: 'escursione Sigiriya, roccia di Sigiriya, roccia del Leone',
    },
    destinations: {
    ...
    guides: {
      ...
      description:
        'Le nostre guide di viaggio complete sullo Sri Lanka, con consigli degli esperti e informazioni pratiche per il tuo viaggio.',
    ...
    destDambulla: {
      ...
      description:
        'Visita il tempio rupestre UNESCO di Dambulla: affreschi, statue del Buddha, consigli per la salita e come combinarlo con Sigiriya in un tour del Triangolo Culturale.',
    ...
    guideVisa: {
      title: 'Guida al visto Sri Lanka | ETA, regole di ingresso e consigli pratici',
      description:
        'Come funzionano l’ETA e il visto all’arrivo in Sri Lanka per i viaggiatori, quali documenti preparare e gli errori comuni di ingresso da evitare.',
      keywords: 'visto Sri Lanka, ETA Sri Lanka, visto all’arrivo, requisiti di ingresso',
    },
    guidePrivateDriver: {
    ...
    guideWildlife: {
      ...
      description:
        'Dove vedere elefanti, leopardi, balene e uccelli in Sri Lanka parchi nazionali, stagioni e migliori spot.',
    ...
    guideFood: {
      ...
      description:
        'Cucina srilankese: rice and curry, hoppers, kottu, spezie e street food cosa provare e come ordinare con sicurezza.',
      keywords: 'cibo Sri Lanka, rice and curry, street food Sri Lanka, cucina srilankese',
    },
    guidePacking: {
      title: 'Cosa mettere in valigia Sri Lanka | Abbigliamento e essenziali',
      description:
        'Lista pratica: abiti per caldo e fresco degli altopiani, codice nei templi, equipaggiamento safari e indispensabili.',
    ...
    cancellation: {
      ...
      description:
        'Modifiche prenotazione, regole di acconto e condizioni di cancellazione per tour privati e autista con Sundown Tours.',
      keywords: 'politica cancellazione, cancellazione tour Sri Lanka, modifica prenotazione',
    },
    restaurants: {
      title: 'Ristoranti in Sri Lanka | La migliore cucina locale',
      description:
        'Scopri i migliori ristoranti dello Sri Lanka con autentica cucina locale e piatti internazionali.',
      keywords: 'ristoranti Sri Lanka, dove mangiare in Sri Lanka',
    },
    testimonials: {
      title: 'Recensioni dei clienti | Sundown Tours Sri Lanka',
      description:
        'Leggi le recensioni dei nostri clienti soddisfatti che hanno vissuto i nostri tour privati in Sri Lanka.',
      keywords: 'recensioni Sri Lanka, testimonianze tour Sri Lanka',
    },
    privacy: {
      title: 'Informativa sulla privacy | Sundown Tours Sri Lanka',
      description: 'Leggi l’informativa sulla privacy e sui cookie analitici di Sundown Tours Sri Lanka.',
    ...
    guideFamilyTours: {
      title: "Tour Sri Lanka in famiglia | Viaggi privati con bambini",
      description: "Tour privati in Sri Lanka pensati per le famiglie, con ritmi sostenibili, safari al mattino e relax in spiaggia.",
      keywords: "tour Sri Lanka famiglia, viaggio privato con bambini, safari in famiglia Sri Lanka",
    },
    guideLuxuryTours: {
