...
export const WHALE_WATCHING_GUIDE: ArticleContent = {
  en: {
    ...
    sections: [
      {
        ...
        body: 'The main departure points are Mirissa and nearby south coast harbours for the southwest monsoon window, and Trincomalee on the east coast when the season shifts. Operators typically leave early morning when seas are calmer and return before midday heat builds.\n\nA private driver makes the logistics practical: overnight near the harbour, early pickup if you stay inland, and a quiet afternoon afterwards in Galle, Ella or your beach hotel rather than rushing a fixed group coach schedule.',
      },
      {
        id: 'season',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'It depends on your travel month and the rest of your itinerary. south coast Mirissa suits winter to spring European holidays ending on the southwest coast; Trincomalee suits east coast seasons. We advise based on your dates.',
      },
      {
        q: 'Can whale watching be added to a 7 day private tour?',
        a: 'Yes. Many 7 to 10 day private routes include a Mirissa morning when the season fits, usually paired with Galle Fort and a beach finish.',
      },
      {
  ...
  de: {
    ...
    lead:
      'Sri Lanka gehort zu den Orten, an denen Blauwale und Pottwale saisonal relativ nah an der Kuste zu sehen sind. Die meisten europaischen Reisenden kombinieren eine morgendliche Bootstour ab Mirissa oder Trincomalee mit einer privaten Chauffeur Route.',
    sections: [
      {
        title: 'Wo Walbeobachtung in Sri Lanka stattfindet',
        body: 'Die wichtigsten Abfahrten sind Mirissa an der Sudkuste und Trincomalee an der Ostkuste  je nach Saison. Fruhe Morgenstunden sind ublich, wenn die See ruhiger ist.\n\nEin privater Fahrer erleichtert die Logistik: Ubernachtung nahe dem Hafen, fruher Transfer und ein ruhiger Nachmittag in Galle, Ella oder im Strandhotel.',
      },
      {
        title: 'Beste Saison und realistische Erwartungen',
        body: 'An der Sudkuste ist die Saison oft etwa von Dezember bis April stark; an der Ostkuste eher von Mai bis September  immer aktuell prufen. Sichtungen sind nie garantiert. Wahlen Sie lizenzierte Boote und meiden Sie „100 %-Garantien“.',
      },
      {
        title: 'Kombination mit einer Privattour',
        body: 'Ein haufiges Muster: Kulturdreieck → Kandy/Ella → Sudkuste (Galle + Mirissa) → Strandtage. Familien legen die Bootstour oft in die Mitte der Reise.',
      },
      {
        title: 'Praktische Tipps fur den Bootstag',
        body: 'Rutschfeste Schuhe, Sonnenschutz, ggf. Mittel gegen Seekrankheit und eine Trockentasche mitnehmen. Treffpunkt, Bootsgrosse und Regeln bei rauem Wetter am Vortag bestatigen.',
      },
      {
        title: 'Planung mit Sundown Tours',
        body: 'Wir planen private Sudor Ostkusten Routen um Ihre Daten und Ihr Tempo. Bootstickets konnen transparent im Angebot stehen oder flexibel bleiben, bis das Wetter klar ist.',
      },
    ],
    faq: [
      {
        q: 'Ist Walbeobachtung in Sri Lanka garantiert?',
        a: 'Nein. Seriose Anbieter garantieren keine Sichtungen.',
      },
      {
        q: 'Mirissa oder Trincomalee?',
        a: 'Abhangig von Reimonat und Restroute. Wir beraten anhand Ihrer Daten.',
      },
      {
    ...
    ctaBody: 'Nennen Sie Reimonat und Gruppengrosse  wir schlagen eine realistische Chauffeur Route vor.',
    ctaLabel: 'Kontakt',
  },
};
