...
const en: CardDict = {
  ...
  tour2ey: {
    title: '2 Day Ella & Yala Safari Tour with 4★ Hotels & Private Transport',
    days: '2 days',
    persons: '1–20 travellers',
    imageAlt: '2 day Ella and Yala private safari tour Sri Lanka',
  },
  tour2ek: {
    title: '2 Day Ella & Kandy Private Tour with 4★ Hotels & Private Transport',
    days: '2 days',
    persons: '1–20 travellers',
  ...
  tour5: {
    title: '5 Day Sri Lanka Tour with 4★ Hotels, Safari & Beach Stay',
    days: '5 days',
    persons: '1–20 travellers',
    imageAlt: '5 day Sri Lanka tour with safari and beach',
  },
  tour6: {
    title: '6 Day Sri Lanka Private Tour with 4★ Hotels, Safari & Beach Stay',
    days: '6 days',
    persons: '1–20 travellers',
    imageAlt: '6 day Sri Lanka private tour package',
  },
  tour7: {
    title: '7 Day Sri Lanka Tour with 4★ Hotels, Safari & Beach Stay',
    days: '7 days',
    persons: '1–20 travellers',
    imageAlt: '7 day Sri Lanka round tour with safari and beach',
  },
  tour8: {
    title: '8 Day Sri Lanka Private Tour with 4★ Hotels, Safari & Beach Stay',
    days: '8 days',
    persons: '1–20 travellers',
    imageAlt: '8 day Sri Lanka private tour package',
  },
  tour10: {
    title: '10 Day Sri Lanka Tour with 4★ Hotels & Private Transport',
    days: '10 days',
    persons: '1–20 travellers',
...
const de: CardDict = {
  ...
  tour2ey: {
    title: '2 Tage Ella & Yala Safari mit 4★ Hotels & Privattransfer',
    days: '2 Tage',
    persons: '1–20 Reisende',
    imageAlt: '2 Tage Ella und Yala Privatsafari Sri Lanka',
  },
  tour2ek: {
    title: '2 Tage Ella & Kandy Privatreise mit 4★ Hotels & Privattransfer',
    days: '2 Tage',
    persons: '1–20 Reisende',
  ...
  tour5: {
    title: '5 Tage Sri Lanka Rundreise mit 4★ Hotels, Safari & Strand',
    days: '5 Tage',
    persons: '1–20 Reisende',
    imageAlt: '5 Tage Sri Lanka Reise mit Safari und Strand',
  },
  tour6: {
    title: '6 Tage Sri Lanka Privatreise mit 4★ Hotels, Safari & Strand',
    days: '6 Tage',
    persons: '1–20 Reisende',
    imageAlt: '6 Tage Sri Lanka Privatreisepaket',
  },
  tour7: {
    title: '7 Tage Sri Lanka Rundreise mit 4★ Hotels, Safari & Strand',
    days: '7 Tage',
    persons: '1–20 Reisende',
    imageAlt: '7 Tage Sri Lanka Rundreise mit Safari und Strand',
  },
  tour8: {
    title: '8 Tage Sri Lanka Privatreise mit 4★ Hotels, Safari & Strand',
    days: '8 Tage',
    persons: '1–20 Reisende',
    imageAlt: '8 Tage Sri Lanka Privatreisepaket',
  },
  tour10: {
    title: '10 Tage Sri Lanka Rundreise mit 4★ Hotels & Privattransfer',
    days: '10 Tage',
    persons: '1–20 Reisende',
...
const fr: CardDict = {
  ...
  tour2ey: {
    title: 'Circuit 2 jours Ella & Yala safari – hôtels 4★ & transport privé',
    days: '2 jours',
    persons: '1–20 voyageurs',
    imageAlt: 'Circuit privé 2 jours Ella et Yala Sri Lanka',
  },
  tour2ek: {
    title: 'Circuit 2 jours Ella & Kandy – hôtels 4★ & transport privé',
    days: '2 jours',
    persons: '1–20 voyageurs',
  ...
  tour5: {
    title: 'Circuit 5 jours – hôtels 4★, safari & plage',
    days: '5 jours',
    persons: '1–20 voyageurs',
    imageAlt: 'Circuit 5 jours Sri Lanka safari et plage',
  },
  tour6: {
    title: 'Circuit privé 6 jours – hôtels 4★, safari & plage',
    days: '6 jours',
    persons: '1–20 voyageurs',
    imageAlt: 'Circuit privé 6 jours au Sri Lanka',
  },
  tour7: {
    title: 'Circuit 7 jours – hôtels 4★, safari & plage',
    days: '7 jours',
    persons: '1–20 voyageurs',
    imageAlt: 'Circuit 7 jours Sri Lanka safari et plage',
  },
  tour8: {
    title: 'Circuit privé 8 jours – hôtels 4★, safari & plage',
    days: '8 jours',
    persons: '1–20 voyageurs',
    imageAlt: 'Circuit privé 8 jours au Sri Lanka',
  },
  tour10: {
    title: 'Circuit 10 jours – hôtels 4★ & transport privé',
    days: '10 jours',
    persons: '1–20 voyageurs',
...
const it: CardDict = {
  ...
  tour2ey: {
    title: 'Tour 2 giorni Ella & Yala safari – hotel 4★ e trasporto privato',
    days: '2 giorni',
    persons: '1–20 viaggiatori',
    imageAlt: 'Tour privato 2 giorni Ella e Yala Sri Lanka',
  },
  tour2ek: {
    title: 'Tour 2 giorni Ella & Kandy – hotel 4★ e trasporto privato',
    days: '2 giorni',
    persons: '1–20 viaggiatori',
  ...
  tour5: {
    title: 'Tour 5 giorni – hotel 4★, safari e spiaggia',
    days: '5 giorni',
    persons: '1–20 viaggiatori',
    imageAlt: 'Tour 5 giorni Sri Lanka safari e spiaggia',
  },
  tour6: {
    title: 'Tour privato 6 giorni – hotel 4★, safari e spiaggia',
    days: '6 giorni',
    persons: '1–20 viaggiatori',
    imageAlt: 'Tour privato 6 giorni in Sri Lanka',
  },
  tour7: {
    title: 'Tour 7 giorni – hotel 4★, safari e spiaggia',
    days: '7 giorni',
    persons: '1–20 viaggiatori',
    imageAlt: 'Tour 7 giorni Sri Lanka safari e spiaggia',
  },
  tour8: {
    title: 'Tour privato 8 giorni – hotel 4★, safari e spiaggia',
    days: '8 giorni',
    persons: '1–20 viaggiatori',
    imageAlt: 'Tour privato 8 giorni in Sri Lanka',
  },
  tour10: {
    title: 'Tour 10 giorni – hotel 4★ e trasporto privato',
    days: '10 giorni',
    persons: '1–20 viaggiatori',
...
const es: CardDict = {
  ...
  tour2ey: {
    title: 'Circuito 2 días Ella y Yala safari – hoteles 4★ y transporte privado',
    days: '2 días',
    persons: '1–20 viajeros',
    imageAlt: 'Circuito privado 2 días Ella y Yala Sri Lanka',
  },
  tour2ek: {
    title: 'Circuito 2 días Ella y Kandy – hoteles 4★ y transporte privado',
    days: '2 días',
    persons: '1–20 viajeros',
  ...
  tour5: {
    title: 'Circuito 5 días – hoteles 4★, safari y playa',
    days: '5 días',
    persons: '1–20 viajeros',
    imageAlt: 'Circuito 5 días Sri Lanka safari y playa',
  },
  tour6: {
    title: 'Circuito privado 6 días – hoteles 4★, safari y playa',
    days: '6 días',
    persons: '1–20 viajeros',
    imageAlt: 'Circuito privado 6 días por Sri Lanka',
  },
  tour7: {
    title: 'Circuito 7 días – hoteles 4★, safari y playa',
    days: '7 días',
    persons: '1–20 viajeros',
    imageAlt: 'Circuito 7 días Sri Lanka safari y playa',
  },
  tour8: {
    title: 'Circuito privado 8 días – hoteles 4★, safari y playa',
    days: '8 días',
    persons: '1–20 viajeros',
    imageAlt: 'Circuito privado 8 días por Sri Lanka',
  },
  tour10: {
    title: 'Circuito 10 días – hoteles 4★ y transporte privado',
    days: '10 días',
    persons: '1–20 viajeros',
...
const pl: CardDict = {
  ...
  tour2ey: {
    title: 'Wycieczka 2 dni Ella i Yala safari – hotele 4★ i prywatny transport',
    days: '2 dni',
    persons: '1–20 podróżnych',
    imageAlt: 'Prywatna wycieczka 2 dni Ella i Yala Sri Lanka',
  },
  tour2ek: {
    title: 'Wycieczka 2 dni Ella i Kandy – hotele 4★ i prywatny transport',
    days: '2 dni',
    persons: '1–20 podróżnych',
  ...
  tour5: {
    title: 'Wycieczka 5 dni – hotele 4★, safari i plaża',
    days: '5 dni',
    persons: '1–20 podróżnych',
    imageAlt: 'Wycieczka 5 dni Sri Lanka safari i plaża',
  },
  tour6: {
    title: 'Prywatna wycieczka 6 dni – hotele 4★, safari i plaża',
    days: '6 dni',
    persons: '1–20 podróżnych',
    imageAlt: 'Prywatna wycieczka 6 dni po Sri Lance',
  },
  tour7: {
    title: 'Wycieczka 7 dni – hotele 4★, safari i plaża',
    days: '7 dni',
    persons: '1–20 podróżnych',
    imageAlt: 'Wycieczka 7 dni Sri Lanka safari i plaża',
  },
  tour8: {
    title: 'Prywatna wycieczka 8 dni – hotele 4★, safari i plaża',
    days: '8 dni',
    persons: '1–20 podróżnych',
    imageAlt: 'Prywatna wycieczka 8 dni po Sri Lance',
  },
  tour10: {
    title: 'Wycieczka 10 dni – hotele 4★ i prywatny transport',
    days: '10 dni',
    persons: '1–20 podróżnych',
...
const ru: CardDict = {
  ...
  tour2ey: {
    title: 'Тур 2 дня Элла и Яла сафари – отели 4★ и частный трансфер',
    days: '2 дня',
    persons: '1–20 путешественников',
    imageAlt: 'Частный тур 2 дня Элла и Яла Шри-Ланка',
  },
  tour2ek: {
    title: 'Тур 2 дня Элла и Канди – отели 4★ и частный трансфер',
    days: '2 дня',
    persons: '1–20 путешественников',
  ...
  tour5: {
    title: 'Тур 5 дней – отели 4★, сафари и пляж',
    days: '5 дней',
    persons: '1–20 путешественников',
    imageAlt: 'Тур 5 дней Шри-Ланка сафари и пляж',
  },
  tour6: {
    title: 'Частный тур 6 дней – отели 4★, сафари и пляж',
    days: '6 дней',
    persons: '1–20 путешественников',
    imageAlt: 'Частный тур 6 дней по Шри-Ланке',
  },
  tour7: {
    title: 'Тур 7 дней – отели 4★, сафари и пляж',
    days: '7 дней',
    persons: '1–20 путешественников',
    imageAlt: 'Тур 7 дней Шри-Ланка сафари и пляж',
  },
  tour8: {
    title: 'Частный тур 8 дней – отели 4★, сафари и пляж',
    days: '8 дней',
    persons: '1–20 путешественников',
    imageAlt: 'Частный тур 8 дней по Шри-Ланке',
  },
  tour10: {
    title: 'Тур 10 дней – отели 4★ и частный трансфер',
    days: '10 дней',
    persons: '1–20 путешественников',
