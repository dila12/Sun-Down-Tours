...
export const PAGE_CONTENT_SOURCES = {
  home: [
    ...
    'src/app/mainComponents/home-page-component/sections/home-seo-section/home-seo.content.ts',
  ...
  about: [
    'src/app/mainComponents/about-component/about-component.ts',
    'src/app/i18n/content/en.ts',
  ],
  ...
  destSigiriya: ['src/app/i18n/destinations/sigiriya.ts', 'src/app/i18n/content/en.ts'],
  destElla: ['src/app/i18n/destinations/ella.ts', 'src/app/i18n/content/en.ts'],
  destYala: ['src/app/i18n/destinations/yala.ts', 'src/app/i18n/content/en.ts'],
  destKandy: ['src/app/i18n/destinations/kandy.ts', 'src/app/i18n/content/en.ts'],
  destDambulla: ['src/app/i18n/destinations/dambulla.ts', 'src/app/i18n/content/en.ts'],
  destGalle: ['src/app/i18n/destinations/galle.ts', 'src/app/i18n/content/en.ts'],
  destMirissa: ['src/app/i18n/destinations/mirissa.ts', 'src/app/i18n/content/en.ts'],
  ...
  guideSafari: ['src/app/i18n/guides/safari.ts', 'src/app/i18n/content/en.ts'],
  ...
  guideTrainJourneys: ['src/app/i18n/guides/trainJourneys.ts', 'src/app/i18n/content/en.ts'],
